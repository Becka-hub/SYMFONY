...
class PresenceController extends AbstractController
{
    ...
    public function index(EmployeRepository $employe, PresenceRepository $presence): Response
    {
        ...
        return $this->render('presence/index.html.twig', [
            ...
            'mois' => array_map(function (Presence $pres) {
                return $pres->tojson();
            }, $mois),
            'date' => array_map(function (Presence $pres) {
                return $pres->tojson();
            }, $date),
        ]);
    }
    ...
    public function ajoutePresence(Request $request, EmployeRepository $employe): Response
    {
        ...
        $em->persist($presence);
        $em->flush();
        return $this->json(['success' => 'Ajoute présence avec succcess !'], 200);
    }
